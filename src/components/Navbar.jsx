	...
	return (
		<div className='absolute w-full flex justify-between p-4 items-center'>
			<h1 className='text-white font-bold text-2xl z-20'>
				Escape{' '}
				<span className='text-cyan-700 font-bold text-2xl z-20'>Haven</span>
			</h1>
			<RiMenu5Line
				onClick={handleNav}
			...
			<div
				className={
					nav
						? 'fixed text-gray-300 left-0 top-0 w-full h-screen bg-black/90 px-4 py-7 flex-col ease-in duration-300 z-10'
